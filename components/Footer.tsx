...
const Footer: React.FC<FooterProps> = ({ onShowPrivacyPolicy, onShowTermsOfService, onShowServicesPage, onShowContactUs }) => {
  return (
    <footer className="mt-16 py-8 border-t border-zinc-800">
      <div className="container mx-auto px-4 text-center text-zinc-500">
        <div className="flex justify-center gap-6 mb-4 flex-wrap">
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); onShowContactUs(); }} className="text-sm text-zinc-400 hover:text-white transition-colors">Contact Us</a>
        </div>
