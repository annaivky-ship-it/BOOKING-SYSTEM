...
import { ArrowLeft, User, Mail, Phone, FileText, Send, Search, LoaderCircle, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    return (
        <div className="animate-fade-in space-y-8">
            ...
            <div className="text-center">
                 <h1 className="text-4xl font-bold text-white">'Do Not Serve' List</h1>
                 ...
                 <div className="space-y-4">
                     {filteredList.length > 0 ? (
                        filteredList.map(entry => {
                           ...
                           const isLongReason = entry.reason.length > 120;
                           ...
                           return (
                               <div key={entry.id} className="bg-zinc-900/70 p-4 rounded-lg border border-zinc-700/50">
                                   ...
                                   <div className="mt-3 pt-3 border-t border-zinc-800 text-zinc-300 italic">
                                        <p className="whitespace-pre-wrap">
                                            "{isExpanded || !isLongReason ? entry.reason : `${entry.reason.substring(0, 120)}...`}"
                                        </p>
                                       {isLongReason && (
                                            <button
                                                onClick={() => handleToggleExpand(entry.id)}
                                                className="text-orange-400 hover:text-orange-300 text-sm font-semibold mt-2 flex items-center gap-1 transition-colors"
